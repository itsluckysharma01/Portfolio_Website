              ...
              <div className="timeline">
                ...
                <div className="timeline-item">
                  ...
                  <div className="timeline-content">
                    ...
                    <p className="timeline-description">
                      ...
                      foundational knowledge of data structures, algorithms, and
                ...
                <div className="timeline-item">
                  ...
                  <div className="timeline-content">
                    ...
                    <p className="timeline-description">
                      ...
                      Physics, Chemistry, and Mathematics (PCM). This provided a
                      strong foundation in core scientific principles and honed
                ...
                <div className="timeline-item">
                  ...
                  <div className="timeline-content">
                    ...
                    <p className="timeline-description">
                      Attained Secondary School Certificate (SSC), demonstrating
                      a strong foundation in core subjects including
                      Mathematics, Science, and Social Studies. Developed
                      essential skills in problem-solving and critical thinking.
                    </p>
                    <div className="timeline-tags">
          ...
          <div className="certifications-list">
                  ...
                  <div className="certification-info">
                    <div>
                      <h3 className="certification-title">
                        Oracle Cloud Infrastructure 2025 Certified Data Science
                        Professional
                      </h3>
            ...
            <div className="certification-card card">
              ...
              <div className="certification-content">
                ...
                <p className="certification-description">
                  The Oracle Cloud Infrastructure 2025 Certified AI Foundations
                  Associate certification validates your foundational knowledge
                  of AI, Machine Learning, and Generative AI, including Large
            ...
            <div className="certification-card card">
              ...
              <div className="certification-content">
                ...
                <p className="certification-description">
                  ...
                  project-based applications, demonstrating the ability to write
                  clean, efficient, and well-documented code to solve real-world
                  problems.
                </p>
                <div className="certification-footer">
