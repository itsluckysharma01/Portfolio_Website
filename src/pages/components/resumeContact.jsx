          ...
          <div className="container">
            <div className="hero-content">
              ...
              <p className="hero-description">
                Ready to collaborate on your next project? Download my resume,
                explore my professional timeline, or get in touch directly.
              </p>
                ...
                <button onClick={downloadResume} className="btn-primary">
                  ...
                  >
                    <path
                      ...
                      strokeWidth="2"
                      d="M12 10v6m0 0l-4-4m4 4l4-4m-6 8h8a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z"
                    />
                  </svg>
            ...
            <div className="availability-status">
              <div className="card">
                ...
                <p className="availability-description">
                  Currently accepting new client projects and collaboration
                  opportunities. Next availability:{" "}
                  <span className="highlight">December 2025</span>
                </p>
                <div className="services-grid">
                  <div className="service-item">
                    <div className="service-title primary">
                      Full-Stack Development
                    </div>
                    <div className="service-subtitle">Web Applications</div>
                  </div>
                  <div className="service-item">
                    <div className="service-title secondary">
                ...
                <div className="timeline">
                  ...
                  <div className="timeline-item">
                    ...
                    <div className="timeline-content">
                      ...
                      <p className="timeline-description">
                        Working as a Machine Learning Engineer on cutting-edge
                        AI projects. Developing and deploying machine learning
                        models, analyzing complex datasets, and implementing AI
                        solutions. Collaborating with experienced professionals
                        to deliver high-impact projects in artificial
                  ...
                  <div className="timeline-item">
                    ...
                    <div className="timeline-content">
                      <div className="timeline-header">
                        <h3 className="timeline-title">
                          B.Tech (Bachelor of Technology) - HPTU
                        </h3>
                        <span className="timeline-badge primary">Current</span>
                      </div>
                      <p className="timeline-company">
                        Govt. College Dharamshala School of Computer Science and
                        Engineering Kangra-HP | • 2022 - Present
                      </p>
                      <p className="timeline-description">
                        Developing and implementing software solutions for
                        academic projects. Collaborating with peers on complex
                        programming assignments and group projects. Applying
                  ...
                  <div className="timeline-item">
                    ...
                    <div className="timeline-content">
                      <h3 className="timeline-title">
                        Senior Secondary - HP BOARD
                      </h3>
                      <p className="timeline-company">
                        GSSS Kachhiari | Kangra-HP | • 2019 - 2021
                      </p>
                      <p className="timeline-description">
                        Completed Senior Secondary education with a focus on
                        Physics, Chemistry, and Mathematics (PCM). This provided
                        a strong foundation in core scientific principles and
                  ...
                  <div className="timeline-item">
                    ...
                    <div className="timeline-content">
                      <h3 className="timeline-title">
                        Matriculation - HP BOARD
                      </h3>
                      <p className="timeline-company">
                        Govt. High School Sinyur | Chamba-HP |• March 2019
                      </p>
                      <p className="timeline-description">
                        Attained Secondary School Certificate (SSC),
                        demonstrating a strong foundation in core subjects
                        including Mathematics, Science, and Social Studies.
                        Developed essential skills in problem-solving and
                        critical thinking.
                      </p>
                      <div className="timeline-tags">
            ...
            <div className="certifications-list">
              ...
              <div className="certification-card card">
                <div className="certification-image-container">
                  <img
                    src="/images/Certificates/01_Oracle_Professional_Data_Science.jpg"
                    alt="Oracle Data Science"
                ...
                <div className="certification-content">
                    ...
                    <div className="certification-info">
                      <div>
                        <h3 className="certification-title">
                          Oracle Cloud Infrastructure 2025 Certified Data
                  ...
                  <p className="certification-description">
                    ...
                    data science, machine learning, and analytics using Oracle
                    technologies.
                  </p>
                  <div className="certification-footer">
                    ...
                    <button className="certification-verify primary">
                      Verify Certificate
                    </button>
                  </div>
                </div>
              ...
              <div className="certification-card card">
                <div className="certification-image-container">
                  <img
                    src="/images/Certificates/02_Oracle_Cloud_Infrastructure.jpg"
                    alt="Oracle Data Science"
                    className="certification-logo"
                    loading="lazy"
                    onClick={() =>
                ...
                <div className="certification-content">
                  <div className="certification-header">
                    <div className="certification-info">
                      ...
                      <span className="certification-badge secondary">
                        Valid
                      </span>
                    </div>
                  </div>
                  <p className="certification-description">
                    The Oracle Cloud Infrastructure 2025 Certified AI
                    Foundations Associate certification validates your
                    foundational knowledge of AI, Machine Learning, and
                  ...
                  <div className="certification-footer">
                    ...
                    <button className="certification-verify secondary">
                      Verify Certificate
                    </button>
                  </div>
                </div>
              ...
              <div className="certification-card card">
                <div className="certification-image-container">
                  <img
                    src="/images/Certificates/04_NIELIT-Internship_Certificate.jpg"
                    alt="Oracle Data Science"
                    className="certification-logo"
                    loading="lazy"
                    onClick={() =>
                ...
                <div className="certification-content">
                  ...
                  <p className="certification-description">
                    Demonstrated expertise in data curation using Python,
                    proficiently employing Pandas and NumPy to clean, transform,
                    and organize large datasets for analysis.
                  </p>
                  <div className="certification-footer">
                    <span className="certification-date">
                      Issued: July 2025
                    </span>
                    <button className="certification-verify accent">
                      Verify Certificate
                    </button>
                  </div>
                </div>
              ...
              <div className="certification-card card">
                <div className="certification-image-container">
                  <img
                    src="/images/Certificates/07_Udemy_Python.jpg"
                    alt="Oracle Data Science"
                    className="certification-logo"
                    loading="lazy"
                    onClick={() =>
                ...
                <div className="certification-content">
                  <div className="certification-header">
                    <div className="certification-info">
                      <div>
                        <h3 className="certification-title">
                          Complete Python Bootcamp for Everyone from Zero to
                          Hero
                        </h3>
                  ...
                  <p className="certification-description">
                    Applied theoretical knowledge to build practical,
                    project-based applications, demonstrating the ability to
                    write clean, efficient, and well-documented code to solve
                    real-world problems.
                  </p>
                  <div className="certification-footer">
                    <span className="certification-date">
          ...
          <div className="container">
            <div className="contact-header">
              ...
              <p className="section-description">
                Ready to collaborate? Choose your preferred way to get in touch
              ...
              <div className="contact-sidebar">
                ...
                <div className="card">
                  ...
                  <div className="contact-methods">
                    <a
                      href="mailto:alex.rodriguez@devportfolio.pro"
                    ...
                    <a
                      href="https://www.linkedin.com/in/lucky-sharma918894599977"
                      className="contact-method"
                      target="_blank"
                      rel="noreferrer"
                    >
                ...
                <div className="card">
                  ...
                  <div className="calendar-widget">
                    ...
                    <p className="calendar-hours">
                      Monday - Friday, 9 AM - 5 PM PST
                    </p>
                    <button
                      onClick={openCalendar}
                      className="btn-secondary calendar-button"
                    >
          ...
          <div className="container">
            <div className="footer-grid">
              ...
              <div className="footer-brand">
                ...
                <p className="footer-description">
                  ...
                  thoughtful design, and innovative problem-solving.
                </p>
                <div className="footer-social">
                  <a
                    href="https://github.com/itsluckysharma01"
                    target="_blank"
                    rel="noreferrer"
              ...
              <div className="footer-links">
                ...
                <ul className="footer-links-list">
                  ...
                  <li>
                    <button className="footer-link" onClick={openCalendar}>
                      Schedule Call
                    </button>
                  </li>
                  <li>
                    <button className="footer-link">Collaboration</button>
                  </li>
                </ul>
              </div>
            </div>
            ...
            <div className="footer-bottom">
              <p className="footer-copyright">
                © 2025 Lucky Sharma. All Rights Reserved. Built with passion and
                precision.
              </p>
            </div>
          </div>
