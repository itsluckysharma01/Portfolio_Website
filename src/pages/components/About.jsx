          ...
          <div className="about-main">
            ...
            <div className="about-info">
              ...
              <p className="about-description">
                I am a Data Science and Analytics and also full-stack developer
                who thrives on creating elegant and intuitive solutions. With
                over 3 years of experience, I specialize in building end-to-end
                applications that integrate my strong skills in data science and
                analysis. I use hands-on projects to apply statistical modeling
                and machine learning, ensuring every solution is not just
                well-built but also data-informed.
              </p>
